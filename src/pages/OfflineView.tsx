...
const OfflineView: React.FC = () => {
  ...
  //fetched data from localStorage if saved, when internet connection is down
  const GetData = () => {
    setObservations(JSON.parse(localStorage.observations));
    setTimeout(function() {
      setIsLoading(false);
  ...
  return (
    <IonPage className="ion__home-container" id="main">
      ...
      <IonContent>
        ...
        <p className="text-center text-danger" style={{ fontSize: 16 }}>
        ...
        {!observations && !isLoading ? (
          <IonList className="text-center p-2 mt-5">
            <h2>
              ...
              <br /> Or, Check your internet connection.
            </h2>
          </IonList>
        ) : (
